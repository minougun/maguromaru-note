...
const STEPS: Step[] = [
  {
    mockId: "intro",
    title: "まぐろ丸ノートへようこそ",
    body: "海鮮丼まぐろ丸の公式アプリです。次のスライドから、ホーム・記録・図鑑・クイズ・称号・アカウント連携でできることを順番に紹介します。",
  },
  {
    mockId: "home",
    title: "ホーム",
  ...
  },
  {
    mockId: "account",
    title: "マイページ・アカウント連携",
    body: "マイページでは、かんたん表示 / 詳細表示や文字サイズを切り替えられます。画面上部の「アカウント連携」から Apple・Google・メールを連携しておくと、機種変更や再インストール後もデータを引き継ぎやすくなります。",
  },
];
