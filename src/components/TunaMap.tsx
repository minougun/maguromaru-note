...
const MAP_REGIONS: MapRegionDef[] = [
  ...
  },
  {
    ...
    shape: {
      ...
      d:
        ...
        // 中央ブロックと尾側ブロックのあいだ（背中〜第2背鰭手前）に空いていた帯を同じ部位として塗る
        "M 797,243 L 922,252 L 934,268 L 905,282 L 862,292 L 812,300 L 770,304 L 797,243 Z",
    },
  ...
  },
  {
    ...
    shape: {
      type: "path",
      d:
        "M 499,327 L 523,303 L 557,299 L 561,299 L 607,300 L 662,302 L 686,304 L 732,309 L 816,321 L 834,325 L 843,328 L 894,394 L 891,403 L 828,446 L 792,468 L 558,452 L 529,422 Z " +
  ...
  },
  {
    ...
    shape: {
      type: "path",
      // reveal 腹の薄ピンク下端（y≈525〜557）までクリップを延ばし、下の余白を詰める
      d: "M 560,557 L 565,480 L 566,477 L 567,475 L 568,474 L 794,456 L 800,456 L 801,457 L 801,459 L 800,470 L 796,482 L 788,496 L 775,510 L 755,524 L 732,536 L 704,546 L 672,552 L 640,555 L 608,557 L 572,557 Z",
    },
  ...
  },
  {
    ...
    shape: {
      type: "path",
      // 尾側ブロック同様、reveal の腹ハイライト下端（左 y≈543・右 y≈557）まで拡張
      d: "M 395,543 L 414,462 L 415,461 L 417,460 L 419,460 L 559,474 L 561,476 L 558,498 L 548,520 L 532,540 L 510,552 L 485,556 L 455,556 L 428,552 L 405,548 Z",
    },
