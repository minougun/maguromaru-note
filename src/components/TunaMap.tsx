...
const MAP_REGIONS: MapRegionDef[] = [
  {
    ...
    shape: {
      type: "path",
      // 参考画像通り：頭部のみ、はみ出し・被りなし。下側を大きく塗りつぶし
      d: "M 260,240 L 345,235 L 365,240 L 365,285 L 345,295 L 260,295 Z",
    },
    label: { x: 228, y: 92 },
    lineTo: { x: 312, y: 250 },
  },
  ...
  // 腹の中トロ polygon が大トロと重なるため、先に中トロを描いてから大トロを上に載せる（さもなくば reveal が大トロを潰す）
  {
    ...
    shape: {
      type: "path",
      // 大トロのカーブに沿わせてギリギリまで上へ詰める（794,456 まで）、右にずらして被り解消
      d: "M 745,536 L 807,456 L 929,434 L 993,407 L 988,460 L 768,524 Z",
    },
