...
const MAP_REGIONS: MapRegionDef[] = [
  {
    ...
    shape: {
      type: "path",
      // 参考画像寄せ: 眉間上の細い短冊状。頭頂全体を塗らず前方寄りに限定
      d: "M 252,238 L 320,229 L 347,235 L 340,270 L 279,283 L 248,272 Z",
    },
    label: { x: 228, y: 92 },
    lineTo: { x: 296, y: 250 },
  },
  ...
  },
  {
    ...
    shape: {
      type: "path",
      d:
        // 参考画像寄せ: 背側の中トロは背びれ下の細い帯。後方までベタ広がりさせない
        "M 352,221 L 426,212 L 505,208 L 585,208 L 648,213 L 700,222 L 726,236 L 719,269 L 674,279 L 601,281 L 520,281 L 442,287 L 386,295 L 360,281 L 350,246 Z",
    },
  ...
  // 腹の中トロ polygon が大トロと重なるため、先に中トロを描いてから大トロを上に載せる（さもなくば reveal が大トロを潰す）
  {
    ...
    shape: {
      type: "path",
      // 参考画像寄せ: 腹の中トロは後方の小さめ三角帯
      d: "M 760,534 L 822,468 L 922,441 L 960,446 L 952,476 L 832,521 Z",
    },
