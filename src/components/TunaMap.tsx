...
const MAP_REGIONS: MapRegionDef[] = [
  ...
  },
  {
    ...
    shape: {
      type: "path",
      d:
        // 上側の青余白を詰めるため上縁一式を約 20px 上方向（y 減）へ。3 サブパスで 560,212 を共有
        "M 373,232 L 388,229 L 434,221 L 462,218 L 491,215 L 536,212 L 550,212 L 553,218 L 556,229 L 559,246 L 560,263 L 560,266 L 558,270 L 405,288 L 403,288 L 395,275 L 374,233 Z " +
        "M 560,212 L 761,207 L 766,207 L 792,213 L 797,221 L 797,223 L 770,284 L 768,286 L 589,272 L 568,270 L 566,266 L 561,231 L 560,217 Z " +
        "M 925,237 L 938,220 L 993,165 L 1002,161 L 1006,164 L 1012,169 L 1087,244 L 1090,249 L 1049,290 L 1045,292 L 1035,295 L 1032,294 L 965,268 L 932,246 Z",
    },
