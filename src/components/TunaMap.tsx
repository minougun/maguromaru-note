 ...
 * 脳天・目裏は楕円、その他は flood＋外周輪郭トレース（RDP 簡略化）で生成した path。
 * WebP を差し替えた場合は scripts/build-map-regions-from-reveal.py で `d` を再生成できる。
 */
const MAP_REGIONS: MapRegionDef[] = [
  ...
  },
  {
    ...
    shape: {
      type: "path",
      d:
        "M 373,252 L 458,238 L 553,232 L 562,290 L 459,299 L 405,310 Z " +
        "M 558,232 L 747,246 L 740,236 L 766,239 L 762,225 L 794,233 L 799,247 L 772,240 L 772,251 L 748,246 L 769,289 L 767,308 L 567,292 Z " +
  ...
  },
  {
    ...
    shape: {
      type: "path",
      d:
        "M 498,328 L 526,300 L 536,299 L 643,300 L 770,313 L 758,363 L 784,383 L 795,363 L 793,318 L 816,320 L 846,328 L 840,396 L 859,388 L 868,365 L 900,397 L 892,405 L 877,406 L 685,406 L 619,413 L 560,430 L 580,434 L 559,454 L 527,421 L 622,376 L 683,360 L 688,347 L 632,331 L 580,329 L 507,338 Z " +
        "M 1116,383 L 1117,377 L 1220,378 L 1208,388 L 1164,388 L 1119,394 L 1116,394 Z",
    },
    label: { x: 1040, y: 336 },
    lineTo: { x: 715, y: 362 },
  },
