...
/** 店舗案内の営業時間（`STORE_INFO.hours`）に合わせ、東京時間 17:00〜22:30 を営業中とみなす */
const OPEN_MINUTES_FROM_MIDNIGHT_JST = 17 * 60;
const CLOSE_MINUTES_FROM_MIDNIGHT_JST = 22 * 60 + 30;
/** 閉店 1 時間前（東京 21:30〜22:29） */
...
/**
 * 閉店 1 時間前の帯か（東京 21:30〜22:29。案内の 22:30 閉店に準拠）
 */
 ...
 * 閉店 1 時間前（東京 21:30〜22:29）は「まもなく終了」（closing_soon）、
