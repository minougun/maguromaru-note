...
export const seededParts: Part[] = [
  { id: "otoro", name: "大とろ", area: "腹部", rarity: 3, description: "最高級の脂のり", color: "#e85555", sort_order: 1 },
  { id: "chutoro", name: "中とろ", area: "背部・腹部", rarity: 2, description: "脂と赤身のバランス", color: "#ff6b6b", sort_order: 2 },
