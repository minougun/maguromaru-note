import { PART_DISPLAY_COLOR_CHUTORO, PART_DISPLAY_COLOR_OTORO } from "@/lib/domain/part-display-colors";
import type {
  MenuItem,
  MenuItemStatusRow,
  Part,
...
export const seededParts: Part[] = [
  { id: "otoro", name: "大とろ", area: "腹部", rarity: 3, description: "最高級の脂のり", color: PART_DISPLAY_COLOR_OTORO, sort_order: 1 },
  { id: "chutoro", name: "中とろ", area: "背部・腹部", rarity: 2, description: "脂と赤身のバランス", color: PART_DISPLAY_COLOR_CHUTORO, sort_order: 2 },
