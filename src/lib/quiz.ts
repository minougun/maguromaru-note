...
const menuQuestions = seededMenuItems.flatMap<QuizQuestionSpec>((menuItem, index) => {
  ...
  const kindAnswer = "まぐろメニュー";
  const kindOptions = buildOptions(
    kindAnswer,
    ["まぐろメニュー", "ドリンク", "限定メニュー", "セット"],
    ["まぐろメニュー", "ドリンク", "限定メニュー", "セット"],
    index + 2,
  );
...
const storeQuestions: QuizQuestionSpec[] = [
  {
    idBase: "store-concept",
    category: "お店",
    question: "「まぐろの鉄人」はどんな店として案内されている？",
    options: [STORE_INFO.concept, "海鮮食べ放題専門店", "セルフ式のフードコート", "立ち食いそば店"],
    answerIndex: 0,
    explanation: `「${STORE_INFO.name}」は ${STORE_INFO.concept} と案内されています。`,
  },
  {
    idBase: "store-region",
    category: "お店",
    question: "店舗があるエリアはどこ？",
    options: [STORE_INFO.region, "大阪・本町", "神戸・三宮", "京都・河原町"],
    answerIndex: 0,
    explanation: `店舗は ${STORE_INFO.region} にあります。`,
  },
  {
    idBase: "store-address",
    category: "お店",
    question: "店舗住所として正しいものは？",
    options: [STORE_INFO.address, "大阪府大阪市中央区久太郎町3-1-27", "大阪府大阪市北区梅田1-1-1", "大阪府堺市堺区北瓦町1-1-1"],
    answerIndex: 0,
  ...
  },
  {
    idBase: "store-phone",
    category: "お店",
    question: "店舗の電話番号として案内されているのは？",
    options: [STORE_INFO.phone, "06-0000-1234", "06-7777-8888", "06-1111-2222"],
    answerIndex: 0,
    explanation: `店舗の電話番号は ${STORE_INFO.phone} です。`,
  },
  {
    idBase: "store-hours",
    category: "お店",
    question: `${STORE_INFO.latestHoursNoticeDate}掲載の4月営業案内で続いている営業時間帯はどれ？`,
    options: [STORE_INFO.hours, "11:30〜13:30（L.O.13:15）", "11:30〜22:30", "24時間営業"],
    answerIndex: 0,
    explanation: `${STORE_INFO.latestHoursNoticeDate} 掲載の4月営業案内では ${STORE_INFO.hours} のディナー営業です。`,
  },
  {
    idBase: "store-regular-holiday",
    category: "お店",
    question: "定休日として案内されているのは？",
    options: [STORE_INFO.regularHoliday, "火曜日", "水曜日", "定休日なし"],
    answerIndex: 0,
    explanation: `定休日は ${STORE_INFO.regularHoliday} です。`,
  },
  {
    idBase: "store-name",
    category: "お店",
    question: "このサービスで案内している対象店舗名はどれ？",
    options: [STORE_INFO.name, "まぐろ市場 南堀江店", "海鮮丼ほんまぐろ", "南堀江まぐろ食堂"],
    answerIndex: 0,
...
for (const menuItem of seededMenuItems) {
  ...
  menuTruthStatements.push(
    ...
    },
    {
      ...
      category: "メニュー",
      subject: menuItem.name,
      text: `${menuItem.name} はまぐろメニューです。`,
      explanation: `${menuItem.name} はまぐろメニューです。`,
    },
    {
...
const storeTruthStatements: Statement[] = [
  {
    ...
    category: "お店",
    subject: "店舗情報",
    text: `${STORE_INFO.name} は ${STORE_INFO.concept} として案内されています。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.concept} として案内されています。`,
  },
  {
    id: "store-truth-2",
    category: "お店",
    subject: "店舗情報",
    text: `${STORE_INFO.name} は ${STORE_INFO.region} の店舗です。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.region} の店舗です。`,
  },
  {
    id: "store-truth-3",
    category: "お店",
  ...
  },
  {
    ...
    category: "お店",
    subject: "電話",
    text: `店舗の電話番号は ${STORE_INFO.phone} です。`,
    explanation: `店舗の電話番号は ${STORE_INFO.phone} です。`,
  },
  {
    id: "store-truth-5",
  ...
  },
  {
    ...
    category: "お店",
    subject: "定休日",
    text: `定休日は ${STORE_INFO.regularHoliday} です。`,
    explanation: `定休日は ${STORE_INFO.regularHoliday} です。`,
  },
  {
    id: "store-truth-7",
    category: "お店",
    subject: "店舗情報",
    text: `${STORE_INFO.name} は ${STORE_INFO.shopLabel} として案内されています。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.shopLabel} として案内されています。`,
  },
  {
    id: "store-truth-8",
    category: "お店",
    subject: "営業時間",
    text: `${STORE_INFO.latestHoursNoticeDate} 掲載の4月営業案内ではランチ営業終了後、ディナーのみ継続です。`,
    explanation: `${STORE_INFO.latestHoursNoticeDate} 掲載の4月営業案内では ${STORE_INFO.hours} のディナー営業です。`,
  },
  {
    id: "store-truth-9",
    category: "お店",
    subject: "店舗情報",
    text: `${STORE_INFO.name} は南堀江4丁目にあります。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.address} にあります。`,
  },
  {
    id: "store-truth-10",
    category: "お店",
    subject: "施設",
    text: `${STORE_INFO.name} は ${STORE_INFO.facility} として案内されています。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.facility} として案内されています。`,
  },
];
...
const storeLieStatements: Statement[] = [
  {
    ...
    category: "お店",
    subject: "店舗情報",
    text: `${STORE_INFO.name} はセルフ式のフードコートです。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.concept} として案内されています。`,
  },
  {
    id: "store-false-2",
  ...
  },
  {
    ...
    category: "お店",
    subject: "住所",
    text: `店舗住所は大阪府大阪市中央区久太郎町3-1-27です。`,
    explanation: `店舗住所は ${STORE_INFO.address} です。`,
  },
  {
    id: "store-false-4",
  ...
  },
  {
    ...
    category: "お店",
    subject: "店舗情報",
    text: `${STORE_INFO.name} は2号店として案内されています。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.shopLabel} として案内されています。`,
  },
  {
    id: "store-false-8",
    category: "お店",
    subject: "営業時間",
    text: `${STORE_INFO.latestHoursNoticeDate} 掲載の4月営業案内でもランチ営業のみ継続です。`,
    explanation: `${STORE_INFO.latestHoursNoticeDate} 掲載の4月営業案内では ${STORE_INFO.hours} のディナー営業です。`,
  },
  {
    id: "store-false-9",
    category: "お店",
    subject: "店舗情報",
    text: `${STORE_INFO.name} は梅田1丁目にあります。`,
    explanation: `${STORE_INFO.name} は ${STORE_INFO.address} にあります。`,
  },
  {
    id: "store-false-10",
